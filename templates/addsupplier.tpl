...
<body>
	...
	<div id="content">
      ...
      <div id="detail-body">
  	  	<form action="index.php?cmd=setup&tsk=savesupplier" method="post">
          ...
          <tr><td></td><td><input type="text" name="address2" size="40"></td></tr>
					...
					<tr><td>Phone Number:</td><td><input type="text" name="phone" size="40"></td></tr>
					<tr><td>Contact Name:</td><td><input type="text" name="contactname" size="40"></td></tr>         
					<tr><td>Contact Phone:</td><td><input type="text" name="contactno" size="40"></td></tr>
					<tr><td></td><td><input type="submit" name="submit" value="Add Supplier" >
